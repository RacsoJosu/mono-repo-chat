...
export const session = pgTable(
  "session",
  {
    ...
    segundoFactorVerificadoEn: timestamp("segundo_factor_verificado_en"),
    reautenticadoEn: timestamp("reautenticado_en"),
  },
...
export const member = pgTable(
  ...
  (table) => [
    uniqueIndex("membresia_empresa_usuario_unica").on(
